...
class Vehicle:
    ...
    def dried_vehicle(self, Volume, A, y, Temp, t, args, h):
        ...
        if phase == "SOLID":
            ...
            P_Solute =  1.9 #self.chem_VP #Chemical("Acetophenone").VaporPressure.solve_property(1e5)  #0.065 #Vapor pressure of Active Pascal
    ...
    def Evaporation_Solution(self, Volume, A, y, Temp, x1, x0, flux, h):
        #print("solution")
        #print("were here")
        Rg = 8.314 #gas constant
        RH = 33 #relative humidity
        ...
        r_Solute = ( 0.9087 * self.chem.mw * 3/4/np.pi ) ** (1.0/3) * 1e-10
        P_Solute = 1.9 #self.chem_VP #Chemical("Nitrobenzene").VaporPressure.solve_property(1e5) #0.065 # #Vapor pressure of Active Pascal
    ...
    def Evaporation_Precipitate(self, V, A, y, Temp, x1, x0, flux, h, V1, V2):
        #print("precipitate")
        Rg = 8.314 #gas constant
        RH = 33 #relative humidity
        ...
        Volume_Active = Volume_Active * (1e+21) #volume in nm3/particle
        r_Solute = ( 0.9087 * self.chem.mw * 3/4/np.pi ) ** (1.0/3) * 1e-10
        P_Solute = 1.9 #self.chem_VP #Chemical("Acetophenone").VaporPressure.solve_property(1e5)  #Vapor pressure of Active Pascal
    ...
    def main(self, params):
        ...
        if V_solu > V_solu_1: # mass out of the solution phase
            dydt = finite_dose_vehicle.Vehicle.Evaporation_Precipitate(self, V, A, y, Temp, x1, x0, flux, h, V1, V2)
        else:
            dydt = finite_dose_vehicle.Vehicle.Evaporation_Solution(self, V, A, y, Temp, x1, x0, flux, h)
