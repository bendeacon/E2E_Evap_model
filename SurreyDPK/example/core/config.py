...
class Config:
    ...
    def readTokens(self, tokens):
        ...
        elif tokens[0] == 'CHEM_VP' : #vapour pressure of the active ingredient
            self.chem_VP = float(tokens[1])
        ...
        # simulation settings
            ...
            self.t_end = string_to_float(tokens[1])
        elif tokens[0] == 'Nsteps':
            self.Nsteps = int(tokens[1])
